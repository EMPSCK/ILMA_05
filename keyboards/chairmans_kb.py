...
edit_group_b2 = InlineKeyboardButton(text="Количество ЛС", callback_data='num_of_lin')
edit_group_b3 = InlineKeyboardButton(text="Количество ЗГС", callback_data='num_of_zgs')
...
edit_jud_r_b11 = InlineKeyboardButton(text="Главный судья соревнований", callback_data='GSS')
edit_jud_r_b12 = InlineKeyboardButton(text="Секретарь соревнований", callback_data='GSK')
edit_jud_r_kb = InlineKeyboardMarkup(inline_keyboard=[[edit_jud_r_b5, edit_jud_r_b7], [edit_jud_r_b8, edit_jud_r_b10], [edit_jud_r_b11, edit_jud_r_b12], edit_jud_r_b9])
